class macos_directory_cleaner (
  ...
  # disabled on circleci as this will likely fail due to the user not being present yet or python (just ordering?)...
  # probably should fix.
  ...
  EOF
    ...
    notify { 'Skipping macos_directory_cleaner configuration in test kitchen environment': }
  }
}
