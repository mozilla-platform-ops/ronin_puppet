...
curl -LO https://github.com/NagiosEnterprises/nrpe/releases/download/nrpe-3.2.1/nrpe-3.2.1.tar.gz
...
curl -LO http://www.nagios-plugins.org/download/nagios-plugins-2.2.1.tar.gz
...
PACKAGE_BASENAME=nrpe-3.2.1$MOZ_SUFFIX
PACKAGE_SHORTNAME=nrpe321
INSTALLDIR=/usr/
