...
function Puppet-Run {
  ...
  process {
    ...
    puppet apply manifests\nodes.pp --onetime --verbose --no-daemonize --no-usecacheonfailure --detailed-exitcodes --no-splay --show_diff --modulepath=modules`;r10k_modules --hiera=win_hiera_config.yaml --logdest $logdir\$datetime-puppetrun.log
