...
@{ revision = $revision; worker_revision = 'e29a4639fd4402431b7a01cb9982b145c3077aa9'; shared_store = 'C:\hg-shared' } | ConvertTo-Json | Set-Content "$seed\seed-receipt.json" -Encoding ASCII
