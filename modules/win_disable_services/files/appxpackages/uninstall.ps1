# IMPORTANT: use 'Continue' so random AppX errors don't hard-fail Puppet
...
function Remove-PreinstalledAppxPackages {
    ...
    $apps = @{
        ...
        "Microsoft.OutlookForWindows"     = @{ VDIState="Unchanged"; URL="https://apps.microsoft.com/detail/9NRX63209R7B?hl=en-us&gl=US"; Description="A best-in-class email experience that is free for anyone with Windows" }
        "Microsoft.MSPaint"               = @{ VDIState="Unchanged"; URL="https://apps.microsoft.com/store/detail/paint-3d/9NBLGGH5FV99"; Description="Paint 3D app (not Classic Paint app)" }
        ...
        "Microsoft.PowerAutomateDesktop"  = @{ VDIState="Unchanged"; URL="https://flow.microsoft.com/en-us/desktop/"; Description="Power Automate Desktop app. Record desktop and web actions in a single flow" }
        ...
        "Microsoft.SkypeApp"              = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/skype/9wzdncrfj364"; Description="Instant message, voice or video call app" }
        "Microsoft.StorePurchaseApp"      = @{ VDIState="Unchanged"; URL=""; Description="Store purchase app helper" }
        "Microsoft.Todos"                 = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/microsoft-to-do-lists-tasks-reminders/9nblggh5r558"; Description="Microsoft To Do makes it easy to plan your day and manage your life" }
        "Microsoft.WinDbg.Fast"           = @{ VDIState="Unchanged"; URL="https://apps.microsoft.com/detail/9PGJGD53TN86?hl=en-us&gl=US"; Description="Microsoft WinDbg" }
        ...
        "Microsoft.Windows.Photos"        = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/microsoft-photos/9wzdncrfjbh4"; Description="Photo and video editor" }
        "Microsoft.WindowsAlarms"         = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/windows-alarms-clock/9wzdncrfj3pr"; Description="Alarms, world clock, timer, stopwatch" }
        "Microsoft.WindowsCalculator"     = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/windows-calculator/9wzdncrfhvn5"; Description="Microsoft Calculator app" }
        "Microsoft.WindowsCamera"         = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/windows-camera/9wzdncrfjbbg"; Description="Camera app" }
        "microsoft.windowscommunicationsapps" = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/mail-and-calendar/9wzdncrfhvqm"; Description="Mail & Calendar apps" }
        ...
        "Microsoft.WindowsMaps"           = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/windows-maps/9wzdncrdtbvb"; Description="Microsoft Maps app" }
        "Microsoft.WindowsNotepad"        = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/windows-notepad/9msmlrh6lzf3"; Description="Notepad (Store version)" }
        "Microsoft.WindowsStore"          = @{ VDIState="Unchanged"; URL="https://blogs.windows.com/windowsexperience/2021/06/24/building-a-new-open-microsoft-store-on-windows-11/"; Description="Windows Store app" }
        ...
        "Microsoft.Winget.Platform.Source"= @{ VDIState="Unchanged"; URL="https://learn.microsoft.com/en-us/windows/package-manager/winget/"; Description="Winget (Windows Package Manager) source" }
        "Microsoft.Xbox.TCUI"             = @{ VDIState="Unchanged"; URL="https://docs.microsoft.com/en-us/gaming/xbox-live/features/general/tcui/live-tcui-overview"; Description="Xbox Title Callable UI" }
        ...
        "Microsoft.XboxSpeechToTextOverlay" = @{ VDIState="Unchanged"; URL="https://support.xbox.com/help/account-profile/accessibility/use-game-chat-transcription"; Description="Xbox game chat transcription" }
        ...
        "Microsoft.ZuneVideo"             = @{ VDIState="Unchanged"; URL="https://www.microsoft.com/en-us/p/movies-tv/9wzdncrfj3p2"; Description="Movies and TV app" }
        ...
        "MicrosoftWindows.Client.WebExperience" = @{ VDIState="Unchanged"; URL=""; Description="Windows 11 Widgets / Web Experience" }
