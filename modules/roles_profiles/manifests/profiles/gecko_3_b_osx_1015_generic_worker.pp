...
class roles_profiles::profiles::gecko_3_b_osx_1015_generic_worker (
    ...
    case $::operatingsystem {
        'Darwin': {
            ...
            $taskcluster_client_id    = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.taskcluster_client_id')
            $taskcluster_access_token = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.taskcluster_access_token')
            $livelog_secret           = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.livelog_secret')
            $quarantine_client_id     = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.quarantine_client_id')
            $quarantine_access_token  = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.quarantine_access_token')
            $bugzilla_api_key         = lookup('generic_worker.datacenter_gecko_3_b_osx_1015.bugzilla_api_key')
