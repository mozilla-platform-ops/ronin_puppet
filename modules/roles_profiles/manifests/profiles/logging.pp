    ...
    case $::operatingsystem {
        ...
        'Darwin': {
            class { 'fluentd':
                ...
                syslog_host          => lookup('papertrail.host', {'default_value' => $syslog_host, 'value_type' => String}),
                syslog_port          => lookup('papertrail.port', {'default_value' => $syslog_port, 'value_type' => Integer}),
