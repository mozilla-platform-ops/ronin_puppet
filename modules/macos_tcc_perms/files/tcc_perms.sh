...
queries_10_15_system=(
    ...
    "REPLACE INTO access VALUES('kTCCServiceScreenCapture','/usr/libexec/sshd-keygen-wrapper',1,1,1,X'fade0c000000003c0000000100000006000000020000001d636f6d2e6170706c652e737368642d6b657967656e2d7772617070657200000000000003',NULL,NULL,'UNUSED',NULL,0,1753446029);"
)
...
queries_14_system=(
    ...
    "REPLACE INTO access VALUES('kTCCServiceScreenCapture','/usr/libexec/sshd-keygen-wrapper',1,2,4,1,X'fade0c000000003c0000000100000006000000020000001d636f6d2e6170706c652e737368642d6b657967656e2d7772617070657200000000000003',NULL,0,'UNUSED',NULL,0,1753446183,NULL,NULL,'UNUSED',0);"
)
